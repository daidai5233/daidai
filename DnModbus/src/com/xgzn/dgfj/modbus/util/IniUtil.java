...
public class IniUtil {
	...
	public static String getProfileString(String file, String section, String variable, String defaultValue)
		...
		String bathPath = ClassLoader.getSystemResource("").getPath();
		BufferedReader bufferedReader = new BufferedReader(new FileReader(bathPath+file));
	...
	public static void main(String[] args) {
		...
		try {
			System.out.println("值读取成功!... " + getProfileString("config.ini", "const", "test", ""));
			System.out.println("修改值!..."+setProfileString("config.ini", "const", "test", "cacacaca"));
		} catch (IOException e) {
